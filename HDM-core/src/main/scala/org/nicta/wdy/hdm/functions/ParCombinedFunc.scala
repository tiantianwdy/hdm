...
import org.nicta.wdy.hdm.model.{PartialDep, FullDep, FuncDependency}
...
class ParCombinedFunc [T:ClassTag,U:ClassTag,R:ClassTag](val dependency:FuncDependency, parallel: Arr[T]=>Arr[R],
                                                         ...
                                                         var curFUnc:ParallelFunction[_,R])  extends ParallelFunction[T,R] with Aggregator[Arr[T], Buf[R]]  {
