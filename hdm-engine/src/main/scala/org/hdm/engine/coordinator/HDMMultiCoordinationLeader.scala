...
import org.hdm.core.server.MultiClusterBackend
import org.hdm.engine.messages._
...
class HDMMultiCoordinationLeader(override val hdmBackend:MultiClusterBackend,
  ...
  def this(cores: Int) {
    this(HDMEngine().getServerBackend("multiple").asInstanceOf[MultiClusterBackend], cores, HDMServerContext.defaultContext)
  }
