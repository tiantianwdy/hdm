...
class ActorConfigExtensionTest extends TestConfig {
  ...
  val conf = ActorConfig(id = "test/testMyActor", name = "testMyActor", clazzName = "com.baidu.bpit.akka.MyActor").withDeploy("akka.tcp://slaveSys@127.0.0.1:8999/user/smsSlave")
  val conf2 = ActorConfig(id = "test/testMyActor2", name = "testMyActor2", clazzName = "com.baidu.bpit.akka.MyActor").withDeploy("akka.tcp://slaveSys@127.0.0.1:10010/user/smsSlave")
  val conf3 = ActorConfig(id = "test/testMyActor3", name = "testMyActor3", clazzName = "com.baidu.bpit.akka.MyActor").withDeploy("akka.tcp://slaveSys@127.0.0.1:8999/user/smsSlave")
