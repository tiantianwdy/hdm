...
import org.hdm.akka.monitor.TestMonitor
...
//    SmsSystem.startAsSlave("akka://smsSystem@172.22.218.167:15100", 15010, false)
  ...
  def testAddActorToSlave() {
    ...
    Thread.sleep(1500) //wait for starting
    val actorPath = SmsSystem.addActor(AddMsg("testActor", "akka.tcp://slaveSys@127.0.0.1:10010/user/smsSlave", "org.hdm.akka.MyClusterActor", null))
