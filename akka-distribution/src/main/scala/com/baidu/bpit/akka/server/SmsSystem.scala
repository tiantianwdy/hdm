...
import com.baidu.bpit.akka.persistence.{ PersistenceExtensionProvider, PersistenceService, CachedKeyValueService }
...
//    persistenceService = PersistenceExtensionProvider(system)
   ...
   * @param msg  参考 [[com.baidu.bpit.akka.messages.AddMsg]]
   */
  ...
  /**
   * 通过参数直接创建一个Actor
   * 底层调用的是 [[com.baidu.bpit.akka.server.SmsSystem.addActor( ) ]]
