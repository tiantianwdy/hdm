...
import com.baidu.bpit.akka.extensions.{CachedDataService, CachedDataQueryService, CachedDataExtensionProvider, MasterExtensionImpl}
import com.baidu.bpit.akka.messages._

import akka.actor.Actor
import akka.actor.ActorRef
import com.baidu.bpit.akka.server.SmsSystem
import com.baidu.bpit.akka.logEx

/**
 * master节点负责管理和维护整个集群的状态，主要的处理逻辑由[[com.baidu.bpit.akka.messages.MasterSlaveProtocol]] 实现
