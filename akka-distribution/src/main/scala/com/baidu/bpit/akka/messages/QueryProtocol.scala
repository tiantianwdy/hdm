 ...
 *
 * @param op
 *           要查询的内容 see: [[com.baidu.bpit.akka.actors.MasterQueryExtensionImpl#handleQueryMsg(com.baidu.bpit.akka.messages.QueryProtocol)]]
 * @param prop
 *             see: [[com.baidu.bpit.akka.extensions.CachedDataQueryService#handleQueryMsg(com.baidu.bpit.akka.messages.QueryProtocol)]]
 * @param key  as `prop`
